...
abstract class _$ExpenseCWProxy {
  ...
  /// This function **does support** nullification of nullable fields. All `null` values passed to `non-nullable` fields will be ignored. You can also use `Expense(...).copyWith.fieldName(...)` to override fields one at a time with nullification support.
  ///
  /// Usage
  /// ```dart
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfExpense.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfExpense.copyWith.fieldName(...)`
class _$ExpenseCWProxyImpl implements _$ExpenseCWProxy {
  ...
  @override
  Expense amount(double amount) => this(amount: amount);

  @override
  Expense category(Category category) => this(category: category);

  @override
  Expense date(DateTime date) => this(date: date);

  @override
  Expense title(String title) => this(title: title);
...
extension $ExpenseCopyWith on Expense {
  /// Returns a callable class that can be used as follows: `instanceOfExpense.copyWith(...)` or like so:`instanceOfExpense.copyWith.fieldName(...)`.
...
extension ExpenseQueryWhereSort on QueryBuilder<Expense, Expense, QWhere> {
  QueryBuilder<Expense, Expense, QAfterWhere> anyExpenseId() {
...
extension ExpenseQueryWhere on QueryBuilder<Expense, Expense, QWhereClause> {
  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseIdEqualTo(
      Id expenseId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseIdNotEqualTo(
      Id expenseId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
              IdWhereClause.lessThan(upper: expenseId, includeUpper: false),
            )
            .addWhereClause(
              IdWhereClause.greaterThan(lower: expenseId, includeLower: false),
            );
      } else {
        return query
            .addWhereClause(
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseIdGreaterThan(
      Id expenseId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.greaterThan(lower: expenseId, includeLower: include),
      );
    });
  }

  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseIdLessThan(
      Id expenseId,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IdWhereClause.lessThan(upper: expenseId, includeUpper: include),
      );
    });
  }

  QueryBuilder<Expense, Expense, QAfterWhereClause> expenseIdBetween(
    Id lowerExpenseId,
    Id upperExpenseId, {
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, int, QQueryOperations> expenseIdProperty() {
    return QueryBuilder.apply(this, (query) {
